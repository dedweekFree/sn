<web:page>
  <web:sql>insertBranchFeeApply</web:sql>
  <web:sql_type>insert</web:sql_type>
  <web:db>Login</web:db>
  <web:multiValue>F_fileno,F_difftime,F_policy,F_prodpk,F_pfee,F_pmemo</web:multiValue>
  <web:successMsg>数据保存成功！</web:successMsg>
  <web:failMsg>数据保存失败！</web:failMsg>
  <web:url>branchfeeapplyok.aspx</web:url>
