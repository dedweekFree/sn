...
<%@page import="java.math.BigDecimal"%>
	...
	String billid = request.getParameter("searchdate").replaceAll("-","")+tem;
    ...
    if(count>0){
		response.sendRedirect("selectybjjb.aspx?searchdate="+makedate+"&bz="+tem+"&stockId="+storid+"&facname="+facname+"&stor="+stor);
	}else{
		response.sendRedirect("selectyjjb.aspx?searchdate="+makedate+"&bz="+tem+"&stockId="+storid+"&facname="+facname+"&stor="+stor+"&billid="+billid+"&state="+(count1>0?"1":"0"));
	}
