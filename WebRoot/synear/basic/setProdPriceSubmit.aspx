<web:page>
  <web:sql>updateProdPrice</web:sql>
  <web:sql_type>insert</web:sql_type>
  <web:db>Login</web:db>
  <web:multiValue>nc_pk,costprice,prodprice,planprice,accountprice,branaccountprice</web:multiValue>
  <web:successMsg>数据保存成功！</web:successMsg>
  <web:failMsg>数据保存失败！</web:failMsg>
  <web:url>setProductPrice.aspx</web:url>
