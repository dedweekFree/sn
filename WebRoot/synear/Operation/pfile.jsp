...
<body>
<form name="form1" method="post" action="/WoermaUploadFileServlet?formname=<%=formname%>&myframeurl=<%=myframeurl%>&picurl=<%=picurl%>&picsize=<%=picsize%>&pix=<%=pix%>&type=<%=type%>&tendtypeid=<%=tendtypeid%>" enctype="multipart/form-data" onsubmit="return chkfrom();">
