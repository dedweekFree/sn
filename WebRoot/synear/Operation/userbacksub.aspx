<web:page>
  <web:sql>insertbackvarrorder</web:sql>
  <web:sql_type>insert</web:sql_type>
  <web:db>Login</web:db>
  <web:multiValue>bid,invcode,invname,invspec,vnumber,backnum,res,cariveroderb_id</web:multiValue>
  <web:successMsg>数据保存成功！</web:successMsg>
  <web:failMsg>数据保存失败！</web:failMsg>
  <web:url>parent.document.location.reload();</web:url>
