package com.xxs.common.dao.impl;
...
import com.xxs.common.dao.BaseDao;
...
/**
 * 时间: 2006-10-10 15:59:02 SqlMapClient是线程安全的，
 * 所以把它设计成单实例，并做为数据对象操作的基类,为它的子
 * 类提供这个对象；同时提供日志工具对象
 * @author zhouchaoyang
 */
public class BaseDaoImpl extends SqlMapClientDaoSupport implements BaseDao {
	...
	private static BaseDaoImpl baseDao=null; 
	static{
